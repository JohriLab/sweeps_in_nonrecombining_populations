...
if __name__=="__main__":
    ...
    for j in range(1,1000):
        file_path=f"/work/users/s/a/sackau/UNC_work/time_dependent/Ns_100/Ns_100_CI/Parul_simulations/faster_simulations/high_CI_paper/s_0.1/high_CI_decided/dist_files/{i}/output_t_100_subs_off_{(i-1)*1000+j}.txt"
        try:
            with open(file_path,'r'):
                ...
                output_folder=f"/work/users/s/a/sackau/UNC_work/time_dependent/Ns_100/Ns_100_CI/Parul_simulations/faster_simulations/high_CI_paper/s_0.1/high_CI_decided/average_data"
