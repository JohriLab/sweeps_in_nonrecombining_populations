...
if __name__=="__main__":
	...
	for j in range(1,1000):
		file_path=f"/work/users/s/a/sackau/UNC_work/N_1000_s_0.01_h_0.5/Post_fixation/selfing_75/txt_files/{i}/Ns_100_output_t_100_subs_off_{(i-1)*1000+j}.txt"
		try:
			with open(file_path,'r'):
				...
				output_folder=f"/work/users/s/a/sackau/UNC_work/N_1000_s_0.01_h_0.5/Post_fixation/selfing_75/average_data"
