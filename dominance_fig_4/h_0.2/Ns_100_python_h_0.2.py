...
if __name__=="__main__":
	...
	for j in range(1,1000):
		file_path=f"/work/users/s/a/sackau/UNC_work/N_1000_s_0.01_h_0.5/Post_fixation/h_0.2/txt_files/{i}/Ns_100_output_t_100_subs_off_{(i-1)*1000+j}.txt"
		try:
			with open(file_path,'r'):
				...
				output_folder=f"/work/users/s/a/sackau/UNC_work/N_1000_s_0.01_h_0.5/Post_fixation/h_0.2/Ns_100_average_data_h_0.2"
				with open(f"{output_folder}/Ns_100_averaged_data_{i}.txt", "w") as outfile:
