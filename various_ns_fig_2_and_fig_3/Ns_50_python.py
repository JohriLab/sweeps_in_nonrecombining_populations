...
if __name__=="__main__":
	...
	for j in range(1,1000):
		file_path=f"/work/users/s/a/sackau/UNC_work/N_1000_s_0.01_h_0.5/Post_fixation/h_0.5/Ns_50/txt_files/{i}/Ns_50_output_subs_off_{(i-1)*1000+j}.txt"
		try:
			with open(file_path,'r'):
				...
				output_folder=f"/work/users/s/a/sackau/UNC_work/N_1000_s_0.01_h_0.5/Post_fixation/h_0.5/Ns_50/Ns_50_average_data"
				with open(f"{output_folder}/Ns_50_averaged_data_{i}.txt", "w") as outfile:
