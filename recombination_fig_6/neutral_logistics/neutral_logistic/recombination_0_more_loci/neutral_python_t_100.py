...
if __name__=="__main__":
	...
	for j in range(1,1000):
		file_path=f"/work/users/s/a/sackau/UNC_work/time_dependent/Ns_100/Ns_100_subs_1_off/t_100/neutral_logistic/recombination_0_more_loci/dist_txt_files_t_100/{i}/output_t_100_subs_off_{(i-1)*1000+j}.txt"
		try:
			with open(file_path,'r'):
				...
				output_folder=f"/work/users/s/a/sackau/UNC_work/time_dependent/Ns_100/Ns_100_subs_1_off/t_100/neutral_logistic/recombination_0_more_loci/average_data_t_100"
