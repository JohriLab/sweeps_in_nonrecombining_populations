...
class sfs():
    ...
    def normalize_histogram(self,histogram,N1,size_data):
        #max_key=max(histogram.keys()) # maximum x value in histogram
        max_key=size_data # size of data
...
if __name__=="__main__":
	...
	for j in range(1,1000):
		file_path=f"/work/users/s/a/sackau/UNC_work/time_dependent/Ns_100/Ns_100_subs_1_off/t_100/neutral_logistic/recombination_0.01_more_loci/dist_txt_files_t_100/{i}/output_t_100_subs_off_{(i-1)*1000+j}.txt"
		try:
			with open(file_path,'r'):
				...
				normalized_histogram=obj.normalize_histogram(histogram,N1,loaded_data.shape[0]) # do normalization of SFS
				...
				output_folder=f"/work/users/s/a/sackau/UNC_work/time_dependent/Ns_100/Ns_100_subs_1_off/t_100/neutral_logistic/recombination_0.01_more_loci/average_data_t_100"
