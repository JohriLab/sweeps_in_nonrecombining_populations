    ...
    def load_data(self):
        ...
        with open(self.data_file) as file:
            ...
            if start_index is None or end_index is None:
                print(f"File format incorrect: {self.data_file}")
                return pd.DataFrame()
...
if __name__=="__main__":
    ...
    for j in range(1,1000):
        file_path=f"/work/users/s/a/sackau/UNC_work/N_1000_s_0.01_h_0.5/Post_fixation/inbred_new/dist_files/{i}/output_t_100_subs_off_{(i-1)*1000+j}.txt"
        try:
            with open(file_path,'r'):
                ...
                output_folder=f"/work/users/s/a/sackau/UNC_work/N_1000_s_0.01_h_0.5/Post_fixation/inbred_new/average_data"
